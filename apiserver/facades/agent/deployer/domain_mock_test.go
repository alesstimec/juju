...
//
//	mockgen -typed -package deployer -destination apiserver/facades/agent/deployer/domain_mock_test.go github.com/juju/juju/apiserver/facades/agent/deployer ControllerConfigGetter,ApplicationService,AgentPasswordService
//
...
func (mr *MockApplicationServiceMockRecorder) GetUnitContainerNames(arg0, arg1 any) *MockApplicationServiceGetUnitContainerNamesCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUnitContainerNames", reflect.TypeOf((*MockApplicationService)(nil).GetUnitContainerNames), arg0, arg1)
	return &MockApplicationServiceGetUnitContainerNamesCall{Call: call}
}

// MockApplicationServiceGetUnitContainerNamesCall wrap *gomock.Call
type MockApplicationServiceGetUnitContainerNamesCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockApplicationServiceGetUnitContainerNamesCall) Return(arg0 []string, arg1 error) *MockApplicationServiceGetUnitContainerNamesCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockApplicationServiceGetUnitContainerNamesCall) Do(f func(context.Context, unit.Name) ([]string, error)) *MockApplicationServiceGetUnitContainerNamesCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationServiceGetUnitContainerNamesCall) DoAndReturn(f func(context.Context, unit.Name) ([]string, error)) *MockApplicationServiceGetUnitContainerNamesCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockAgentPasswordService) SetModelPassword(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetModelPassword", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetModelPassword indicates an expected call of SetModelPassword.
func (mr *MockAgentPasswordServiceMockRecorder) SetModelPassword(arg0, arg1 any) *MockAgentPasswordServiceSetModelPasswordCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetModelPassword", reflect.TypeOf((*MockAgentPasswordService)(nil).SetModelPassword), arg0, arg1)
	return &MockAgentPasswordServiceSetModelPasswordCall{Call: call}
}

// MockAgentPasswordServiceSetModelPasswordCall wrap *gomock.Call
type MockAgentPasswordServiceSetModelPasswordCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockAgentPasswordServiceSetModelPasswordCall) Return(arg0 error) *MockAgentPasswordServiceSetModelPasswordCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockAgentPasswordServiceSetModelPasswordCall) Do(f func(context.Context, string) error) *MockAgentPasswordServiceSetModelPasswordCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAgentPasswordServiceSetModelPasswordCall) DoAndReturn(f func(context.Context, string) error) *MockAgentPasswordServiceSetModelPasswordCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
